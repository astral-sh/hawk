...
/// source-crate roots, distinct documentation root fields, and exact-target
/// documentation mode were added in 12.
...
pub const DOCUMENTATION_ENV: &str = "HAWK_DOCUMENTATION";
